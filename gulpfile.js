...
gulp.task( 'compile', function () {
    gulp.src( ['./es/**/*.jsx', './es/**/*.js', '!./src/**/*.test.js', '!./src/**/codepen/*.jsx'], { base: './es' } )
        .pipe( babel( {
...
gulp.task( 'build', function () {
    gulp.src( ['./src/**/*.jsx', './src/**/*.js', '!./src/**/*.test.js', '!./src/**/codepen/*.jsx'], { base: './src' } )
        .pipe( babel( {
            presets: ['es2015', 'react', 'stage-2']
        } ) )
        .pipe( transformJSStaticSCSSToCss() )
    ...
    gulp.src( ['./src/**/*.tsx', './src/**/*.ts'], { base: './src' } )
        .pipe( ts( {
            declaration: true,
...
gulp.task( 'watch', function () {
    gulp.watch( ['!./src/**/codepen/*.jsx', '!./src/**/*.test.js', './src/**/*.tsx', './src/**/*.ts', './src/**/*.jsx', './src/**/*.js', './src/**/*.scss', './src/**/*.svg', './src/**/*.json'], ['build'] );
} );